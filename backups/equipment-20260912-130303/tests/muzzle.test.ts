...
import {muzzlePixels,muzzlePixel,weaponPoint,dronePoint,fitProjectile,poseSize} from '../src/game/WeaponSockets';
...
it('covers all 21 identities and every texture pose within 160px',()=>{
