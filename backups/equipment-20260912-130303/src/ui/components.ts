...
export const combatPortrait = (id: string) =>
  `<img class="recruit-portrait" src="${assetUrl(`/assets/face-icons/${id}.webp`)}" alt="${heroById[id].name} 얼굴" width="256" height="256" draggable="false"/>`;
