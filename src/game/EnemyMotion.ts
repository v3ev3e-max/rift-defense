...
/** Regional enemy sheets are authored as six-frame loops, including bosses. */
export function enemyMoveFrameCount(boss:boolean,regional:boolean){
  return regional?6:boss?8:6;
}
