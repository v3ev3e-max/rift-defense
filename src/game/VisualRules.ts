...
export const heroVisuals: Record<string, { projectile: number; impact: number; skill: number }> = {
  ...
  hana:{projectile:56,impact:78,skill:128},zion:{projectile:84,impact:72,skill:126},
  gaia:{projectile:62,impact:86,skill:136},elise:{projectile:86,impact:76,skill:132},
