...
const regions=[
 ...
 {names:['수정 항구','푸른 단층','심해 회랑','유리 산호초','파도 제단','부유 정원','빙정 관문','심연 교각','핵광 접근로','수정 군도전'],background:'map-13-1.png',enemies:['crystal_bastion','tide_skimmer','prism_cannon','coral_singer'],hp:4.8,attack:2.25,speed:.68,power:9400,reward:5400,recommendation:'수정 방벽 파괴 + 공명 치유 차단',theme:'수정 방벽이 피해를 흡수하고 산호 공명이 주변 적을 회복합니다.'},
 {names:['월광 온실','포자 회랑','은빛 수로','생체 격리실','달의 심장','재생 정원','환영 묘목원','월핵 방벽','심층 배양실','월식 수호전'],background:'map-14-1.png',enemies:['lunar_husk','spore_leaper','moon_ray','bloom_keeper'],hp:5.2,attack:2.42,speed:.69,power:11200,reward:6500,recommendation:'포자 도약 저지 + 재생 연결 차단',theme:'포자 도약과 월광 사격이 후열을 위협하고 재생 연결망이 전선을 복구합니다.'},
 {names:['성간 도크','용광성 회랑','합금 성운','맥동 제련로','항성 모루','수복 격납고','플라즈마 교차로','신성 제철소','별핵 접근로','성간 제련전'],background:'map-15-1.png',enemies:['stellar_plate','plasma_hound','nova_turret','forge_conductor'],hp:5.7,attack:2.62,speed:.70,power:13400,reward:7800,recommendation:'과열 장갑 파괴 + 제련 지휘체 우선',theme:'과열 장갑과 플라즈마 돌진이 교차하며 제련 지휘체가 공격 주기를 가속합니다.'},
 {names:['기원 문턱','태초 회랑','원초 정원','인과 교차로','창세 제단','무한 전망대','세계선 감옥','기원 방벽','최초 좌표','원초 균열전'],background:'map-16-1.png',enemies:['origin_warden','causal_blade','genesis_eye','fate_weaver'],hp:6.2,attack:2.85,speed:.72,power:16000,reward:9500,recommendation:'이중 탱커 + 인과 지원체 차단',theme:'원초 개체가 돌진·저격·회복을 연계합니다. 두 전선을 분리하고 인과 연결을 끊으세요.'},
] as const;
...
const regionalNamed=['named_meadow','named_coast','named_autumn','named_snow','named_lab','named_cold','named_abyss','named_rift','named_sky','named_dune','named_machine','named_time','named_crystal','named_lunar','named_stellar','named_origin'] as const;
export const regionalMidBoss=['verdant_stalker','coral_mauler','thorn_matriarch','frost_howler','security_exarch','cryo_hunter','phase_reaper','rift_executioner','storm_wyvern','sand_colossus','forge_overseer','chrono_reaper','crystal_leviathan','lunar_devourer','starforged_titan','causal_reaper'] as const;
export const regionalFinalBoss=['gale_colossus','leviathan','ancient_treant','glacial_tyrant','reactor_behemoth','absolute_zero','void_observer','rift_sovereign','sky_dominion','solar_sphinx','machine_god','aeon_sovereign','prismatic_empress','eclipse_heart','supernova_foundry','origin_sovereign'] as const;
